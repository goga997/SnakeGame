...
class Snake {
    ...
    private var snakeArray: [GameCell] = [GameCell(col: 0, row: 0), GameCell(col: 0, row: 1)]
    ...
    func crashTest() -> Bool {
        ...
        return snakeWithoutHead.contains(where: {$0.col == snakeHead.col && $0.row == snakeHead.row})
    }
}
